...
<form action='<c:url value="/tour"/> ' id="formSubmit" method="get">
    <div class="main-wrapper">
        <!-- PAGE TITLE -->
        <section>
            <div class="pageTitle page-image-tour-tag" style="background-image:url(<c:url value="/template/web/image/danh-muc-tour.jpg"/>)">
            </div>
        </section>
        <section>
            <div class="container" style="position: relative">
                <div class="background-description">
                    <h1 class="tour-banner-title">Danh sách tour</h1>
                    <div class="sticker">
                        Tour Trong Nước
                    </div>
                </div>
                        ...
                        <div class="filter-list-tour">
                            ...
                            <c:if test="${sortCode == 1}">
                                <div class="filter-tour" >
                                    ...
                                    <a class="filter-div"
                                       href="<c:url value="/tour?page=1&limit=5&_sort=sap-toi#main-content"/>">
                                        [ Ngày gần nhất ]
                                    </a>
                                </div>
                            </c:if>
                            <c:if test="${sortCode == 2}">
                                <div class="filter-tour" >
                                    <a class="filter-div" href="<c:url value="/tour?page=1&limit=5&_sort=gia-thap#main-content"/>">
                                        [ Giá thấp nhất ]
                                    </a>
