...
<div class="main-content">
    <form action='<c:url value="/quan-tri/dia-diem/danh-sach"/>' id="formSubmit" method="get">
                            ...
                            <div class="table-btn-controls">
                                <div class="pull-right tableTools-container">
                                    <div class="dt-buttons btn-overlap btn-group">
                                        <c:url var="createPlaceURL" value="/quan-tri/dia-diem/chinh-sua" />
                                    ...
                                    <table class="table table-bordered center">
                                        ...
                                        <c:forEach var="item" items="${model.listResult}">
                                            <tr>
                                                ...
                                                <td>${item.parentPlaceName}</td>
                                                <td>
                                                    <c:url var="updatePlaceURL" value="/quan-tri/dia-diem/chinh-sua">
                                                        <c:param name="id" value="${item.id}"/>
                                                    </c:url>
                                                    <a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip"
                                                       title="Cập nhật" href='${updatePlaceURL}'>
    ...
    function deletePlace(data) {
        $.ajax({
            ...
            success: function (result) {
                window.location.href = "${placeURL}?page=1&limit=10&message=delete_success";
            },
