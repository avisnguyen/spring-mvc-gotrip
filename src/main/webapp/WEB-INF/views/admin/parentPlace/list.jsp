...
<div class="main-content">
    <form action='<c:url value="/quan-tri/khu-vuc/danh-sach"/>' id="formSubmit" method="get">
                            ...
                            <div class="table-btn-controls">
                                <div class="pull-right tableTools-container">
                                    <div class="dt-buttons btn-overlap btn-group">
                                        <c:url var="createPPURL" value="/quan-tri/khu-vuc/chinh-sua" />
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach var="item" items="${model.listResult}">
                                            <tr>
                                                ...
                                                <td>${item.code}</td>
                                                <td>
                                                    <c:url var="updatePPURL" value="/quan-tri/khu-vuc/chinh-sua">
                                                        <c:param name="id" value="${item.id}"/>
                                                    </c:url>
                                                    <a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip"
                                                       title="Cập nhật" href='${updatePPURL}'>
    ...
    function warningBeforeDelete() {
        swal({
            ...
            if (isConfirm.dismiss) {
                ...
                deleteParentPlace(ids);
            }
        });
    }
    function deleteParentPlace(data) {
        $.ajax({
            url: '${parentPlaceAPI}',
            type: 'DELETE',
            ...
            success: function (result) {
                window.location.href = "${parentPlaceAPI}?page=1&limit=10&message=delete_success";
            },
            error: function (error) {
                window.location.href = "${parentPlaceAPI}?page=1&limit=10&message=error_system";
            }
        });
    }
</script>
